            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form action="" method="post" class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select  class="form-control" name="alipay_api" onchange="api_qh('ali',this.value)">
                                    <option value="1" <?php echo $conf['alipay_api'] == 1 ? "selected" : "";?> >支付宝官方[PC+手机]</option>
                                    <option value="5" <?php echo $conf['alipay_api'] == 5 ? "selected" : "";?> >支付宝官方[当面付]</option>
                        ...
                        <!--对接支付宝官方信息-->
                        <div id="ali_gf_info2" style="<?php
                        echo $conf['alipay_api'] == 5 ? "" : "display: none;";
                        ?>" >
                            <div class="form-group">
                                <label class="col-sm-3 control-label">APPID:</label>
                                <div class="col-sm-9">
                                    <input type="text" name="ali_app_id" value="<?php
                                    echo $conf['ali_app_id'];
                                    ?>" class="form-control"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="ali_public_key" value="<?php
                                    echo $conf['ali_public_key'];
                                    ?>" class="form-control"/>
                                    <small> * 支付宝公钥</small>
                                </div>
                            </div><br/>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="ali_merchant_private_key" value="<?php
                                    echo $conf['ali_merchant_private_key'];
                                    ?>" class="form-control"/>
                                    <small> * 商户私钥</small>
                                </div>
                            </div><br/>
                        ...
                        ?>">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    ?>" class="form-control"/>
                                    <small> * 网站的URL地址 例如:http://pay.zxzxz.wang/</small>
                                </div>
                            </div><br/>
                            <div class="form-group">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form action="" method="post" class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select  class="form-control" name="wxpay_api" onchange="api_qh('wx',this.value)">
                                    ...
                                    ?> >易支付</option>
                                    <option value="6" <?php
                                    echo $conf['wxpay_api'] == 6 ? "selected" : "";
                                    ?> >易商户</option>
                                    <option value="3" <?php
                        ...
                        <!--对接易商户信息-->
                        <div id="wx_eshanghu_info" style="<?php
                        echo $conf['wxpay_api'] == 6 ? "" : "display: none;";
                        ?>">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">APP_KEY</label>
                                <div class="col-sm-9">
                                    <input type="text" name="wx_eshanghu_app_key" value="<?php
                                    echo $conf['wx_eshanghu_app_key'];
                                    ?>" class="form-control"/>
                                    <small> * 用户中心开发设置中获取<a href="https://1shanghu.com/i/00BRTE" class="btn btn-danger btn-xs">易商户官网</a></small>
                                </div>
                            </div><br/>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">APP_SECRET</label>
                                <div class="col-sm-9">
                                    <input type="text" name="wx_eshanghu_app_secret" value="<?php
                                    echo $conf['wx_eshanghu_app_secret'];
                                    ?>" class="form-control"/>
                                    <small> * 用户中心开发设置中获取<a href="https://1shanghu.com/i/00BRTE" class="btn btn-danger btn-xs">易商户官网</a></small>
                                </div>
                            </div><br/>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">SUB_MCH_ID:</label>
                                <div class="col-sm-9">
                                    <input type="text" name="wx_eshanghu_sub_mch_id" value="<?php
                                    echo $conf['wx_eshanghu_sub_mch_id'];
                                    ?>" class="form-control"/>
                                    <small> * https://1shanghu.com/user/wechat/certification 获取</small>
                                </div>
                            </div><br/>
                        </div>   <!-- END 对接易商户信息-->
