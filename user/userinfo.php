	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<form class="form-horizontal devform">
                ...
                <?php if ($conf['safe_switch'] == 0){}else{ ?>
                <div class="line line-dashed b-b line-lg pull-in"></div>
                <h4>二次安全码验证设置</h4>
                <?php if (empty($userrow['safecode'])){?>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">设置安全码</label>
                        <div class="col-sm-9">
                            <input class="form-control" type="text" name="safecode" value="<?php echo $userrow['safecode']?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-4"><input type="button" id="editsafecode" value="设置" class="btn btn-primary form-control"/><br/>
                        </div>
                    </div>
                <?php }else{?>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-4"><input type="button" id="editsafecode" value="确定修改" class="btn btn-primary form-control"/><br/>
                        </div>
                    </div>
                <?php }?>
                <?php }?>
...
$(document).ready(function(){
    ...
    $("#editsafecode").click(function(){
        var safecode=$("input[name='safecode']").val();
        if(safecode==''){layer.alert('请确保各项不能为空！');return false;}
        var ii = layer.load(2, {shade:[0.1,'#fff']});
        $.ajax({
            type : "POST",
            url : "ajax2.php?act=edit_safecode",
