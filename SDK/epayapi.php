...
/*$alipay_config['partner'] = $_POST['partner'];
$alipay_config['key'] = $_POST['key'];
$alipay_config['sign_type'] = $_POST['sign_type'];
$alipay_config['input_charset'] = $_POST['input_charset'];
$alipay_config['transport'] = $_POST['transport'];
$alipay_config['apiurl'] = $_POST['apiurl'];*/
